...
const Paises = () => {
    ...
    const confirmDelete = (paisId, token) => {
        Swal.fire({
			...
			if (result.isConfirmed) {
				actions.eliminarPais(paisId, token)
			Swal.fire({
				title: "Deleted!",
    ...
    const handleDelete = async (paisId) => {
        ...
        confirmDelete(paisId, newToken.token)
    }
                            ...
                            <tr key={id}>
                                ...
                                <td>
                                    <Row>
                                        ...
                                        <Col className="d-flex justify-content-center align-items-center">
                                            <Button variant="outline-primary" href={"/crearPais/" + pais.id}>
